...
buffer_seek(collisionBuffer, buffer_seek_start, 4);
var modelX = buffer_read(collisionBuffer, buffer_f32);
var modelY = buffer_read(collisionBuffer, buffer_f32);
var modelZ = buffer_read(collisionBuffer, buffer_f32);
var modelSize = buffer_read(collisionBuffer, buffer_f32);
...
var tris = smf_collision_get_nearest_region(collisionBuffer, newX, newY, newZ);
for (i = 0; i < array_length_1d(tris); i ++)
{
vert = smf_collision_get_triangle(collisionBuffer, tris[i]);
